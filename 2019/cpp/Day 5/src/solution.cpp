...
int main(int argc, char **argv) {
  ...
  Computer testComputerEqualPosition(exampleEqualPosition, false);
  ...
  Computer testComputerLessThanPosition(exampleLessThanPosition, false);
  ...
  Computer testComputerEqualImmediate(exampleEqualImmediate, false);
  ...
  Computer testComputerLessThanImmediate(exampleLessThanImmediate, false);
  ...
  Computer testComputerJumpPosition(exampleJumpPosition, false);
  ...
  Computer testComputerJumpImmediate(exampleJumpImmediate, false);
